...
urlpatterns = [
    ...
    path('api/capture-fingerprint/', capture_fingerprint, name='capture_fingerprint'),
    path('api/identify-fingerprint/', identify_student_by_fingerprint,
        name='identify_student_by_fingerprint'),
